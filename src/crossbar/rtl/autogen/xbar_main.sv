...
module xbar_main (
  ...
  assign tl_vicuna0_scratchpad_data_o = tl_s1n_7_ds_h2d[1];
  assign tl_s1n_7_ds_d2h[1] = tl_vicuna0_scratchpad_data_i;

  assign tl_vicuna0_scratchpad_instr_o = tl_s1n_7_ds_h2d[2];
  assign tl_s1n_7_ds_d2h[2] = tl_vicuna0_scratchpad_instr_i;

  assign tl_vicuna1_scratchpad_data_o = tl_s1n_7_ds_h2d[3];
  assign tl_s1n_7_ds_d2h[3] = tl_vicuna1_scratchpad_data_i;

  assign tl_vicuna1_scratchpad_instr_o = tl_s1n_7_ds_h2d[4];
  assign tl_s1n_7_ds_d2h[4] = tl_vicuna1_scratchpad_instr_i;

  assign tl_uart_o = tl_s1n_7_ds_h2d[5];
  assign tl_s1n_7_ds_d2h[5] = tl_uart_i;

  assign tl_s1n_7_us_h2d = tl_management_core_data_i;
  assign tl_management_core_data_o = tl_s1n_7_us_d2h;
